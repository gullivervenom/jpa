...
public class ProblemEXTests {
    ...
    /* title. 테스트 코드 기반으로 JPA 를 사용하지 않았을 때 문제 EX */

    /* comment.
    *   테스트 전용 클래스란?
    *   @Test 라는 어노테이션을 1개 이상 가지고 있는 클래스를 의미.
    ...
    *   */
    ...
    void closeConnection() throws SQLException {
        System.out.println("AfterEach 동작하나ㅣ?");
        con.rollback();
        con.close();
    }
    ...
    *   1. 데이터 변환, SQL 문 작성, JDCB 코드 중복 작성 문제
    ...
    *   */
    ...
    /* index. 3. 패러다임 불일치 문제 (객체지향 관점에서 벗어남, 상속, 다형성, 캡슐화, 추상화 등) */
